  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        {
          label: "Bonus*: Flutter Development Bootcamp",
          items: [
            ...
            { label: "Navigation", slug: "flutter/navigation" },
            { label: "State Management", slug: "flutter/state-management" },
            { label: "Networking & API", slug: "flutter/networking" },
            { label: "Final Project", slug: "flutter/project" },
          ],
        },
      ],
    }),
